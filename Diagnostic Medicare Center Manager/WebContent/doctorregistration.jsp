...
<form action="<%= request.getContextPath() %>/docregistration" method="post">
<table width = 25% >
	<tr>
	...
	<br>
	<tr>
	<td style = "color:#FFFC00;font-size:150%">Degree :</td>
	<td><input type=text name="Degree" maxlength= "50" required></td>
	</tr>
	<br><tr>
	<td style = "color:#FFFC00;font-size:150%">Specialty :</td>
	<td><input type=text name="Specialty" maxlength= "50" required></td>
	</tr>
	<br>
	<tr>
	<td style = "color:#FFFC00;font-size:150%">Work hours :</td>
	<td><input type="number" name="Work hours" maxlength="3"
        required></td>
	</tr>
	<br>
	 <tr>
	<td style = "color:#FFFC00;font-size:150%">Hospital Name :</td><td><input type=text name="Hospital Name" maxlength= "100"  required></td>
	</tr>
	<br>
        <tr>
