<%@ page language="java" import="java.sql.*,com.cts.DbConn,javax.servlet.http.*" contentType="text/html; charset=ISO-8859-1"
...
%>
<form action="checkup.jsp" >
<table>
<tr><td style = "color:#FFFC00;font-size:150%">
doctorid:</td><td><input type=text name="doctorid" value=<%= rs.getString(1)%>>
</td></tr>
<br>
<tr><td style = "color:#FFFC00;font-size:150%">
firstname:</td><td><input type=text name="firstname" value=<%= rs.getString(2)%>>
</td></tr>
<br>
<tr><td style = "color:#FFFC00;font-size:150%">
lastname:</td><td><input type=text name="lastname" value=<%= rs.getString(3)%>>
</td></tr>
<br>
<tr><td style = "color:#FFFC00;font-size:150%">
age:</td><td><input type=text name="age" value=<%= rs.getString(4)%>>
</td></tr>
<br>
<tr><td style = "color:#FFFC00;font-size:150%">
gender:</td><td><input type=text name="gender" value=<%= rs.getString(5)%>>
</td></tr>
<br>
<tr><td style = "color:#FFFC00;font-size:150%">
dob:</td><td><input type=text name="dob" value=<%= rs.getString(6)%>>
</td></tr>
<br>
...
<tr><td style = "color:#FFFC00;font-size:150%">degree:</td><td><input type=text name="degree" value=<%= rs.getString(16)%>><br></td></tr>
...
<tr><td align = center>
<input type=submit  value="checkup request"></td></tr>
<%     
       session.setAttribute("mid",medicareserviceid);
