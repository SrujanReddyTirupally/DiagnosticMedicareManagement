...
<%
	...
	PreparedStatement pst=con.prepareStatement("select * from agent where agentid=?");
	pst.setString(1,agentid);
	ResultSet rs=pst.executeQuery();
	rs.next();
%>
<form action="AdminViewAgent.jsp" >
<table width = 25% >
...
<tr><td style = "color:#FFFC00;font-size:150%">contact:</td><td><input type=text name="contactnumber" value=<%= rs.getString(7)%>></td></tr><br>
<tr><td style = "color:#FFFC00;font-size:150%">altcontact:</td><td><input type=text name="altcontactnumber" value=<%= rs.getString(8)%>></td></tr><br>
<tr><td style = "color:#FFFC00;font-size:150%">email:</td><td><input type=text name="emailid" value=<%= rs.getString(9)%>></td></tr><br>
<tr><td style = "color:#FFFC00;font-size:150%">address1:</td><td><input type=text name="addressline1" value=<%= rs.getString(11)%>></td></tr><br>
<tr><td style = "color:#FFFC00;font-size:150%">address2:</td><td><input type=text name="addressline2" value=<%= rs.getString(12)%>></td></tr><br>
